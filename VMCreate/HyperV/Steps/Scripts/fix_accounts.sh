...
# NOTE: this script shipped with `x11_session="` — an unterminated quote
# that made the WHOLE script unparseable (bash aborted at parse time).
# Found by the bash -n lint guard when the script moved to a .sh resource.
x11_session=""
